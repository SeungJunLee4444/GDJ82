...
CREATE TABLE BBS(
    ...
    WRITER VARCHAR2(20 BYTE) NOT NULL,	-- sha-256 테스트 크기 : 64byte
    TITLE VARCHAR2(1000 BYTE) NOT NULL, -- 제목이 곧 내용
    IP VARCHAR2(30 BYTE) NOT NULL,
    CREATE_DATE DATE NOT NULL,
    STATE NUMBER(1) NOT NULL,            -- 정상 1 삭제 0
    DEPTH NUMBER(2) NOT NULL,            -- 원글 0 1차댓글 1 대댓글 2
    GROUP_NO NUMBER NOT NULL,            -- 원글과 모든 댓글은 같은 GROUP_NO를 가짐, 원글 : BBS_NO 댓글 : 원글의 BBS_NO
    GROUP_ORDER NUMBER NOT NULL,          -- 동일 그룹 내 표시 순서(작성순서가 아님)
